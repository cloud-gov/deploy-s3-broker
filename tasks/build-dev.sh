...
ACCESS_KEY_ID=$(grep 's3_broker_user_access_key_id_curr' terraform-yaml-development | awk '{print $2}')
SECRET_ACCESS_KEY=$(grep 's3_broker_user_secret_access_key_curr' terraform-yaml-development | awk '{print $2}')
